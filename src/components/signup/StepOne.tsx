                ...
                <div className='w-full h-full flex flex-col justify-center'>
                    <div className='flex flex-col gap-8'>   
                            <div className='flex flex-col gap-4 text-white'>
                                ...
                                <div className='flex flex-col gap-1'>
                                    <label htmlFor='password' className='text-primary-marine-blue font-medium text-sm'>
                                        Senha
                                    </label>
                                    <input
                                        type='password'
                                ...
                                <div className='flex flex-col gap-1'>
                                    <label htmlFor='retry-password' className='text-primary-marine-blue font-medium text-sm'>
                                        Repetir Senha
                                    </label>
                                    <input
                                        type='password'
