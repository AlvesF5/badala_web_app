export default function SectorDetails({ register, errors, data, updateFieldHandler }: { register: any, errors: any, data: any, updateFieldHandler: any }) {
        ...
        <div>
            ...
            {data.sectors.map((sector: any, index: number) => (
                <div key={index} className="mb-6">
                    ...
                    <div className='grid grid-cols-1 md:grid-cols-3 gap-4'>
                        <div className="relative z-0 w-full mb-5 group">
                            <input
                                ...
                                onChange={(e) => handleSectorChange(index, 'capacity', Number(e.target.value))}
                                type="number"
                        ...
                        <div className="relative z-0 w-full mb-5 group">
                            <input
                                ...
                                value={sector.salePrice || 0}
                                onChange={(e) => handleSectorChange(index, 'salePrice', Number(e.target.value))}
                                type="number"
                    ...
                    <button type="button" onClick={() => removeSector(index)} className="text-red-500">Remover Setor</button>
                </div>
            ))}
